  ...
  return (
    <View style={{
      ...
      <View style={{ flex: 1 }}>
        ...
        <ThemedText variant="text2" color={Color.text.main}>
          내가 부족함이 없으리로다. <ThemedText variant="text5" color={Color.text.main}>(시 23:1)</ThemedText>
        </ThemedText>
      </View>
      <TouchableOpacity onPress={onMenuPress} style={{ width: 60, height: 60, justifyContent: 'center', alignItems: 'center', backgroundColor: 'white', borderRadius: 96 }}>
